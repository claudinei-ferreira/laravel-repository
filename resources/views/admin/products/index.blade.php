...
@section('content_header')
    <div class="row mb-2">
        ...
        <div class="col-sm-6 text-right">
            <a href="{{ route('admin.products.create') }}" class="btn btn-primary"><i class="fas fa-plus"></i> Novo Produto</a>
        </div>
    </div>
@stop
        ...
        <div class="col-sm-12">
            <div class="card card-default">
                <div class="card-header">
                    ...
                    @if (isset($filters))
                            <a href="{{ route('admin.products.index') }}">(x) Limpar Resultados da Pesquisa</a>
                    @endif
                </div>
                <div class="card-body">
